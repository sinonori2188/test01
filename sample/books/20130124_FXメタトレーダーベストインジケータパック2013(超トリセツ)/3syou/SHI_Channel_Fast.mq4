...
//---- 
	...
	DelObj();
	ObjectCreate("2TL1",OBJ_TREND,0,T2,PP+Step*AB,T1,PP); 
		ObjectSet("2TL1",OBJPROP_COLOR,Black); 
		ObjectSet("2TL1",OBJPROP_WIDTH,2); 
		ObjectSet("2TL1",OBJPROP_STYLE,STYLE_SOLID); 
	ObjectCreate("2TL2",OBJ_TREND,0,T2,P2,T1,P1); 
		ObjectSet("2TL2",OBJPROP_COLOR,Black); 
		ObjectSet("2TL2",OBJPROP_WIDTH,2); 
		ObjectSet("2TL2",OBJPROP_STYLE,STYLE_SOLID); 
	ObjectCreate("2MIDL",OBJ_TREND,0,T2,(P2+PP+Step*AB)/2,T1,(P1+PP)/2);
		ObjectSet("2MIDL",OBJPROP_COLOR,Black); 
		ObjectSet("2MIDL",OBJPROP_WIDTH,1); 
		ObjectSet("2MIDL",OBJPROP_STYLE,STYLE_DOT); 
//----
   return(0);
  }
//+------------------------------------------------------------------+