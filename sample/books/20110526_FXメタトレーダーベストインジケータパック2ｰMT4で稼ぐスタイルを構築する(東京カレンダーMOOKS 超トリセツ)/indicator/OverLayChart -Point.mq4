...
int init() {
   ...
   SetIndexStyle( 0, DRAW_NONE, DRAW_LINE, 1, BullBarColor );
   SetIndexStyle( 1, DRAW_NONE, DRAW_LINE, 1, BearBarColor );
   SetIndexStyle ( 2, DRAW_LINE, DRAW_LINE, 1, BullBarColor );
   SetIndexStyle(3,DRAW_ARROW,0,1,BearBarColor);
   SetIndexArrow(0,158);
