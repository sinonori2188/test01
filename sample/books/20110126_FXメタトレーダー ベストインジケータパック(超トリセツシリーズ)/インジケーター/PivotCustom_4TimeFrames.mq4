...
if (Fhr==true)
{
   if(ObjectFind("Fhr_R1 label") != 0)
   {
      ...
      ObjectSetText("Fhr_R1 label", "Fhr_R1 " +DoubleToStr(Fhr_R1,4), 8, "Arial", Black);
   }
   else
   {
   ...
   if(ObjectFind("Fhr_R2 label") != 0)
   {
      ...
      ObjectSetText("Fhr_R2 label", "Fhr_R2 " +DoubleToStr(Fhr_R2,4), 8, "Arial", Black);
   }
   else
   {
   ...
   if(ObjectFind("Fhr_R3 label") != 0)
   {
      ...
      ObjectSetText("Fhr_R3 label", "Fhr_R3 " +DoubleToStr(Fhr_R3,4), 8, "Arial", Black);
   }
   else
   {
   ...
   if(ObjectFind("Fhr_P label") != 0)
   {
      ...
      ObjectSetText("Fhr_P label", "Fhr_Pivot " +DoubleToStr(Fhr_P,4), 8, "Arial",Black);
   }
   else
   {
   ...
   if(ObjectFind("Fhr_S1 label") != 0)
   {
      ...
      ObjectSetText("Fhr_S1 label", "Fhr_S1 " +DoubleToStr(Fhr_S1,4), 8, "Arial", Black);
   }
   else
   {
   ...
   if(ObjectFind("Fhr_S2 label") != 0)
   {
      ...
      ObjectSetText("Fhr_S2 label", "Fhr_S2 " +DoubleToStr(Fhr_S2,4), 8, "Arial", Black);
   }
   else
   {
   ...
   if(ObjectFind("Fhr_S3 label") != 0)
   {
      ...
      ObjectSetText("Fhr_S3 label", "Fhr_S3 " +DoubleToStr(Fhr_S3,4), 8, "Arial", Black);
   }
   else
   {
...
ObjectSetText("Fhr_M5 label", " Fhr_M5 " +DoubleToStr(Fhr_M5,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("Fhr_M4 label", "Fhr_M4 " +DoubleToStr(Fhr_M4,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("Fhr_M3 label", "Fhr_M3 " +DoubleToStr(Fhr_M3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("Fhr_M2 label", "Fhr_M2 " +DoubleToStr(Fhr_M2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("Fhr_M1 label", "Fhr_M1 " +DoubleToStr(Fhr_M1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("Fhr_M0 label", "Fhr_M0 " +DoubleToStr(Fhr_M0,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_R1 label", "                              D_R1 " +DoubleToStr(D_R1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_R2 label", "                              D_R2 " +DoubleToStr(D_R2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_R3 label", "                              D_R3 " +DoubleToStr(D_R3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_P label", "                               D_Pivot " +DoubleToStr(D_P,4), 8, "Arial",Black);
}
else
{
...
ObjectSetText("D_S1 label", "                              D_S1 " +DoubleToStr(D_S1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_S2 label", "                              D_S2 " +DoubleToStr(D_S2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_S3 label", "                              D_S3 " +DoubleToStr(D_S3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_M5 label", "                              D_M5 " +DoubleToStr(D_M5,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_M4 label", "                              D_M4 " +DoubleToStr(D_M4,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_M3 label", "                              D_M3 " +DoubleToStr(D_M3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_M2 label", "                              D_M2 " +DoubleToStr(D_M2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_M1 label", "                              D_M1 " +DoubleToStr(D_M1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("D_M0 label", "                              D_M0 " +DoubleToStr(D_M0,4), 8, "Arial", Black);
}
else
{
...
if (weekly==true)
   ...
   if(ObjectFind("W_R1 label") != 0)
   {
      ...
      ObjectSetText("W_R1 label", "W_R1 " +DoubleToStr(W_R1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_R2 label", "W_R2 " +DoubleToStr(W_R2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_R3 label", "W_R3 " +DoubleToStr(W_R3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_P label", "W_Pivot " +DoubleToStr(W_P,4), 8, "Arial",Black);
}
else
{
...
ObjectSetText("W_S1 label", "W_S1 " +DoubleToStr(W_S1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_S2 label", "W_S2 " +DoubleToStr(W_S2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_S3 label", "W_S3 " +DoubleToStr(W_S3,4), 8, "Arial", Black);
}
else
{
...
ObjectSet("W_P line", OBJPROP_COLOR, Magenta);
}
else
{
...
ObjectSetText("W_M5 label", "W_M5 " +DoubleToStr(W_M5,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_M4 label", "W_M4 " +DoubleToStr(W_M4,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_M3 label", "W_M3 " +DoubleToStr(W_M3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_M2 label", "W_M2 " +DoubleToStr(W_M2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_M1 label", "W_M1 " +DoubleToStr(W_M1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("W_M0 label", "W_M0 " +DoubleToStr(W_M0,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_R1 label", " M_R1 " +DoubleToStr(M_R1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_R2 label", " M_R2 " +DoubleToStr(M_R2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_R3 label", " M_R3 " +DoubleToStr(M_R3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_P label", "M_Pivot " +DoubleToStr(M_P,4), 8, "Arial",Black);
}
else
{
...
ObjectSetText("M_S1 label", "M_S1 " +DoubleToStr(M_S1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_S2 label", "S2 " +DoubleToStr(M_S2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_S3 label", "M_S3 " +DoubleToStr(M_S3,4), 8, "Arial", Black);
}
else
{
...
ObjectSet("M_S1 line", OBJPROP_COLOR, Green);
}
else
{
...
ObjectSet("M_S2 line", OBJPROP_COLOR, Green);
}
else
{
...
ObjectSet("M_S3 line", OBJPROP_COLOR, Green);
}
else
{
...
ObjectSet("M_P line", OBJPROP_COLOR, Magenta);
}
else
{
...
ObjectSet("M_R1 line", OBJPROP_COLOR, Salmon);
}
else
{
...
ObjectSet("M_R2 line", OBJPROP_COLOR, Salmon);
}
else
{
...
ObjectSet("M_R3 line", OBJPROP_COLOR, Salmon);
}
else
{
...
ObjectSetText("M_M5 label", " M_M5 " +DoubleToStr(M_M5,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_M4 label", " M_M4 " +DoubleToStr(M_M4,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_M3 label", " M_M3 " +DoubleToStr(M_M3,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_M2 label", " M_M2 " +DoubleToStr(M_M2,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_M1 label", " M_M1 " +DoubleToStr(M_M1,4), 8, "Arial", Black);
}
else
{
...
ObjectSetText("M_M0 label", " M_M0 " +DoubleToStr(M_M0,4), 8, "Arial", Black);
}
else
{
